                  ...
                  >
                    <div className={`flex gap-3 max-w-[85%] ${msg.role === 'user' ? 'flex-row-reverse text-right' : 'flex-row text-left'}`}>
                      ...
                      <div className="flex flex-col">
                        <div className={`
                          ${msg.role === 'assistant'
                            ? 'font-serif font-normal text-[16.5px] sm:text-[19px] text-white/90 leading-snug italic'
                            : 'font-sans text-[10px] sm:text-[12px] tracking-[0.15em] uppercase text-gold-300/70 border-r border-gold-300/20 pr-3 leading-normal'
                          }
                          whitespace-pre-line
                        `}>
                          {msg.role === 'assistant'
